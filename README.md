...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| No Public Source Code (v3) | v3.0 - Not open source | Webuniversum - Style guidelines for Flemish government websites and applications. Maintained by Government of Flanders. 10 years of development. Older v2.0 was open source. [Figma library](https://mono.company/community/new-community-resource-flemish-government-figma-library/) available |
...
| Storybook / Figma | 🟡 | [Wiki documentation](https://govbr-ds.gitlab.io/govbr-ds-wiki/) available, community on Discord |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/vrk-kpa/suomifi-design-system) | Active development | Suomi.fi Design System library developed and maintained by the Digital and Population Data Services Agency. Components utilized in Suomi.fi Web Service |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/GouvernementFR/dsfr) | v1.14+ - Active development | DSFR (Système de Design de l'État) - Set of HTML, CSS, and JavaScript web components. Managed by Service d'Information du Gouvernement (SIG) |
| Underpinning Technology | HTML/CSS/JS | Web components for quality, accessible digital interfaces |
| Web Components | 🟢 | Full web components library, [React version](https://github.com/dataesr/react-dsfr) available |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/italia/designers.italia.it) | Active - Multiple repos | Designers Italia provides guidelines, tools, design system and community for Public Administration services. Includes [Bootstrap Italia](https://github.com/italia/bootstrap-italia) web development kit and [UI Kit](https://github.com/italia/design-ui-kit) |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/GOVTNZ/govtnz-design-system) | Alpha phase - Active development | NZ Government Design System (NZGDS) by All of Government Services Delivery. Built on GOV.UK Design System foundation. Available as [@govtnz/ds on NPM](https://www.npmjs.com/package/@govtnz/ds) |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code - Deprecated Altinn repos](https://github.com/Altinn/DesignSystem) | Active on designsystemet.no | Designsystemet - shared toolbox of foundational UI components, guidelines, and patterns. Recognized as digital public good by Digital Public Goods Alliance (DPGA). Used by 70+ agencies |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/scottish-government-design-system/design-system) | Active development - [@scottish-government/design-system on NPM](https://www.npmjs.com/package/@scottish-government/design-system) | Scottish Government Design System for Scottish Government and other Scottish public sector bodies. Live examples with guidance |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/GovTechSG/sgds) | Active development | Singapore Government Design System (SGDS) - open-source, comprehensive collection of components, patterns and templates. Developed to create fast, accessible and mobile-friendly digital services |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/alphagov/govuk-frontend) | Active development - Latest review Dec 2024 | GOV.UK Design System - GOV.UK Frontend contains code for building user interfaces for government platforms and services. Extensive support with styles, components, and patterns |
| Underpinning Technology | HTML/CSS/JavaScript | Reusable, accessible components for forms, navigation, panels, tables and more |
| Web Components | 🟢 | Full component library, community projects available at [X-GOVUK](https://x-govuk.github.io/projects/) |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/NHS-digital-website/design-system) | Active development - [Storybook latest](https://design-system.digital.nhs.uk/storybook/latest/) | NHS Digital Design System provides code for accessible user interfaces for NHS Digital websites and services |
...
| **Feature** | **Status** | **Other Info** |
| :---------- | :--------- | :------------- |
| [Source Code](https://github.com/uswds/uswds) | Active development since 2015 | U.S. Web Design System (USWDS) - comprehensive library of components and patterns. Helps federal government build fast, accessible, mobile-friendly websites |
